...
import 'package:dado/src/transformer/mock_sdk.dart' as mock_sdk show sources;
...
final dadoSourcesPath = Directory.current.path.endsWith('transformer')
    ? '../../lib/'
    : '../lib/';

String readPackageFile(String f) => new File(path.join(dadoSourcesPath, f))
    .readAsStringSync();
